...
func (t *SimpleChaincode) Init(stub shim.ChaincodeStubInterface, function string, args []string) ([]byte, error) {
	...
	err = stub.PutState("Bank1", []byte(Bank1))
	if err != nil {
		return nil, err
	}
	err = stub.PutState("Bank2", []byte(Bank2))
	if err != nil {
		return nil, err
	}
	err = stub.PutState("Bal1", []byte(Bal1))
		if err != nil {
			return nil, err
		}
	err = stub.PutState("Bal2", []byte(Bal2))
		if err != nil {
			return nil, err
		}
...
fmt.Printf("Our Query Response11--------------------------------->:%s\n", jsonResp1)
	...
	fmt.Printf("jsonRows :%s", jsonRows)
	//return jsonRows, nil
	return []byte (opa_data1), nil
}
