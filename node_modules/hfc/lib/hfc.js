...
var Chain = (function () {
     ...
     */
    Chain.prototype.eventHubConnect = function (peeraddr) {
...
var ChainCodeCBE = (function () {
    function ChainCodeCBE(ccid, eventname, payload, cb) {
        this.ccid = ccid;
...
var EventHub = (function () {
    ...
    EventHub.prototype.setPeerAddr = function (peeraddr) {
    ...
    EventHub.prototype.registerChaincodeEvent = function (ccid, eventname, callback) {
        if (!this.connected)
            return;
        var cb = new ChainCodeCBE(ccid, eventname, null, callback);
        var register = { register: { events: [{ eventType: "CHAINCODE", chaincodeRegInfo: { chaincodeID: ccid, eventName: eventname } }] } };
        this.chaincodeRegistrants.put(ccid + "/" + eventname, cb);
        this.call.write(register);
    };
    EventHub.prototype.unregisterChaincodeEvent = function (ccid, eventname) {
        if (!this.connected)
            return;
