...
export declare class EventHub {
    ...
    private connected;
    constructor();
    setPeerAddr(peeraddr: string): void;
    isconnected(): boolean;
    connect(): void;
    disconnect(): void;
    registerChaincodeEvent(ccid: string, eventname: string, callback: Function): void;
    unregisterChaincodeEvent(ccid: string, eventname: string): void;
